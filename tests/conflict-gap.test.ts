/**
 * The team-vs-OTM gap helper — the frontend's copy.
 *
 * This file and its fixture are byte-identical twins of the ones in
 * sidelineiq-agents apart from the import path. That is deliberate: the two
 * implementations must agree exactly, because the agent decides whether to
 * FLAG a conflict and this repo decides what number to SHOW for it, and they
 * disagreeing is the bug this whole change exists to fix. If you change one,
 * change both and re-copy the fixture.
 *
